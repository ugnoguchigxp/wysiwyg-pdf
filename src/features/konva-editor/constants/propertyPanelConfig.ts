...
import type { UnifiedNode, ShapeNode, WidgetNode } from '@/types/canvas'
 ...
 */
export function resolvePreset<T>(
    ref: PresetRef<T>,
...
export interface FontWidgetConfig extends BaseWidgetConfig {
    type: 'font'
    props?: {
        showFamily?: boolean; showSize?: boolean; showColor?: boolean
        showBold?: boolean; showItalic?: boolean; showUnderline?: boolean; showStrikethrough?: boolean
...
export interface FillWidgetConfig extends BaseWidgetConfig { type: 'fill'; props?: { showOpacity?: boolean } }
export interface BorderWidgetConfig extends BaseWidgetConfig { type: 'border'; props?: { showColor?: boolean; showWidth?: boolean } }
export interface PolygonWidgetConfig extends BaseWidgetConfig { type: 'polygon'; props?: { min?: number; max?: number; step?: number } }
export interface ImageWidgetConfig extends BaseWidgetConfig { type: 'image'; props?: { showPreview?: boolean; showUploader?: boolean; maxPreviewHeight?: number } }
export interface LabelFieldWidgetConfig extends BaseWidgetConfig { type: 'labelField'; props?: { fieldKey?: string; placeholder?: string } }
export interface HiddenFieldWidgetConfig extends BaseWidgetConfig { type: 'hiddenField'; props?: { fields: string[] } }
export interface SelectWidgetConfig extends BaseWidgetConfig { type: 'select'; props: { fieldKey: string; options: { value: string; labelKey: string }[] } }
export interface ColorPickerWidgetConfig extends BaseWidgetConfig { type: 'colorPicker'; props: { fieldKey: string } }
export interface SliderWidgetConfig extends BaseWidgetConfig { type: 'slider'; props: { fieldKey: string; min: number; max: number; step?: number; showValue?: boolean } }
export interface TextContentWidgetConfig extends BaseWidgetConfig { type: 'textContent'; props?: { rows?: number; placeholder?: string } }
export interface LineStyleWidgetConfig extends BaseWidgetConfig { type: 'lineStyle'; props?: { options: ('solid' | 'dashed' | 'dotted')[] } }
...
export const DEFAULT_FONT_SIZES = [
    8, 9, 10, 10.5, 11, 12, 14, 16, 18, 20, 22, 24, 26, 28, 32, 36, 40, 44, 48, 54, 60, 66, 72, 80, 88, 96,
]
...
export const WIDGET_PRESETS: Record<string, WidgetConfig> = {
    ...
    'font:full': {
        ...
        grid: { cols: 2, gap: 8 },
        props: {
            showFamily: true, showSize: true, showColor: false,
            showBold: true, showItalic: true, showUnderline: true, showStrikethrough: true,
        },
    },
    'font:basic': {
        type: 'font',
