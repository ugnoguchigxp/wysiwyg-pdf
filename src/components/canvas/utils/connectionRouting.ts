 ...
 */
export const getAnchorPointAndDirection = (geo: NodeGeometry, anchor: Anchor): AnchorInfo => {
...
export const getOrthogonalConnectionPath = (
  ...
  const resolveDiagonal = (current: AnchorInfo, target: { x: number; y: number }): AnchorInfo => {
