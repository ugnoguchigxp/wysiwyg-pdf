  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1 flex-shrink-0">
        {item.status === 'in_progress' && (
          <Button variant="ghost" size="icon" onClick={cancel} title="Cancel" className="h-7 w-7">
            <X className="h-4 w-4" />
          </Button>
        )}

        {item.status === 'failed' && (
          <Button variant="ghost" size="icon" onClick={retry} title="Retry" className="h-7 w-7">
        ...
        {(item.status === 'completed' ||
          ...
          <Button variant="ghost" size="icon" onClick={remove} title="Remove" className="h-7 w-7">
            <X className="h-4 w-4" />
          </Button>
        )}
      </div>
