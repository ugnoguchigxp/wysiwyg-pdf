...
vi.mock(
  '../../../../../src/modules/konva-editor/report-editor/pdf-editor/components/Toolbar/WysiwygEditorToolbar',
  () => ({
...
vi.mock('../../../../../src/modules/konva-editor/report-editor/ReportKonvaEditor', async () => {
...
vi.mock(
  '../../../../../src/modules/konva-editor/report-editor/pdf-editor/components/PropertiesPanel/WysiwygPropertiesPanel',
  () => ({
...
import { ReportEditor } from '../../../../../src/modules/konva-editor/report-editor/ReportEditor'
