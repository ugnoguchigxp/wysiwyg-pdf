...
describe('WysiwygPropertiesPanel', () => {
  it('updates text element and recalculates size on font size change', () => {
    ...
    const doc: any = {
      ...
      nodes: [
        { id: 't1', t: 'text', s: 'p1', x: 0, y: 0, w: 10, h: 10, text: 'Hello', fontSize: 12, fill: '#000000' },
      ],
    }
    ...
    const next = onTemplateChange.mock.calls.at(-1)?.[0]
    const updated = next.nodes.find((n: any) => n.id === 't1')
    ...
    render(
      <WysiwygPropertiesPanel
        templateDoc={{
          ...
          unit: 'pt',
          surfaces: [{ id: 'p1', type: 'page', w: 100, h: 100 }],
          nodes: [{ id: 'sig', t: 'signature', s: 'p1', x: 0, y: 0, w: 10, h: 10, strokes: [], stroke: '#000', strokeW: 1 }],
        } as any}
