...
vi.mock('../../../../../src/components/canvas/KonvaCanvasEditor', async () => {
...
vi.mock('../../../../../src/modules/konva-editor/bedLayout/components/PaperBackground', () => ({
  PaperBackground: () => <div data-testid="paper-bg" />,
}))

vi.mock('../../../../../src/modules/konva-editor/bedLayout/elements/BedElement', () => ({
  BedElement: () => <div data-testid="bed-element" />,
}))

import { BedLayoutEditor } from '../../../../../src/modules/konva-editor/bedLayout/BedLayoutEditor'
