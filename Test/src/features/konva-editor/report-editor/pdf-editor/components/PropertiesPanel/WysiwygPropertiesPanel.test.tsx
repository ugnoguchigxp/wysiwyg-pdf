...
vi.mock('../../../@/features/report-editor/pdf-editor/utils/textUtils', () => ({
...
import { WysiwygPropertiesPanel } from '../../../@/features/report-editor/components/PropertiesPanel/WysiwygPropertiesPanel'
