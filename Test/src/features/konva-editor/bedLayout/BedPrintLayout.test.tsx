  ...
  it('renders bed/text/shape/line/image and skips hidden/invalid elements', async () => {
    const doc = {
      ...
      nodes: [
        ...
        { id: 't1', t: 'text', s: 'layout', x: 0, y: 0, w: 50, h: 20, text: 'Hello', fontSize: 12, fill: '#000', align: 'l' },
        { id: 's1', t: 'shape', s: 'layout', x: 5, y: 5, w: 10, h: 10, shape: 'Rect', stroke: '#000', strokeW: 1, fill: '#fff' },
        { id: 'l1', t: 'line', s: 'layout', pts: [0, 0, 10, 10], stroke: '#000', strokeW: 1 },
        { id: 'img1', t: 'image', s: 'layout', x: 0, y: 30, w: 20, h: 20, src: 'data:image/png;base64,xxx' },
        { id: 'img2', t: 'image', s: 'layout', x: 30, y: 30, w: 20, h: 20, src: 'asset-id' },
        { id: 'hidden', t: 'text', s: 'layout', x: 0, y: 60, w: 50, h: 20, text: 'Hidden', hidden: true },
        { id: 'invalid', t: 'unknown' },
      ],
    } as any
