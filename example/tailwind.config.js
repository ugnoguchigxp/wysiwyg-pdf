  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'theme-object-primary': 'var(--theme-object-primary)',
        'theme-object-secondary': 'var(--theme-object-secondary)',
        'theme-object-tertiary': 'var(--theme-object-tertiary)',
        'theme-border': 'var(--theme-border)',
        'theme-accent': 'var(--theme-accent)',
        'theme-success': 'var(--theme-success)',
        'theme-warning': 'var(--theme-warning)',
        'theme-danger': 'var(--theme-danger)',
        'theme-text-on-color': 'var(--theme-text-on-color)',
        'theme-shadow-contrast': 'var(--theme-shadow-contrast)',
